...
void KeyboardInterface::SetKeyPressed(Control key) {
...
void KeyboardInterface::SetKeyReleased(Control key) {
  is_control_pressed_[key] = false;
}

bool KeyboardInterface::IsKeyPressed(Control key) {
  return is_control_pressed_[key];
}

KeyboardInterface& KeyboardInterface::GetInstance() {
