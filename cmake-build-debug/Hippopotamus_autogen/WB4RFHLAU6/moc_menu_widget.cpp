...
QT_MOC_LITERAL(1, 11, 14), // "StartGameEvent"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 17), // "LoadSettingsEvent"
QT_MOC_LITERAL(4, 45, 9) // "ExitEvent"

    },
    "MenuWidget\0StartGameEvent\0\0LoadSettingsEvent\0"
    "ExitEvent"
};
...
void MenuWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->StartGameEvent(); break;
        case 1: _t->LoadSettingsEvent(); break;
        case 2: _t->ExitEvent(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuWidget::StartGameEvent)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MenuWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuWidget::LoadSettingsEvent)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MenuWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuWidget::ExitEvent)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void MenuWidget::StartGameEvent()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MenuWidget::LoadSettingsEvent()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void MenuWidget::ExitEvent()
{
